...
o() {
    if [ $# -eq 0 ]; then
        ...
        # Jika ada argumen, z ke argumen tersebut lalu buka nvim di direktori saat ini
        z "$@" && nvim
    fi
}
setopt NO_BEEP
...
# tmux config
# Auto-attach tmux to last session when opening terminal
# if command -v tmux >/dev/null 2>&1; then
#   # Jangan auto attach jika sudah di dalam tmux
#   if [[ -z "$TMUX" ]]; then
#     # Jika ada session, attach. Kalau tidak ada, create baru.
